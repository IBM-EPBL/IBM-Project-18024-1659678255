...
COS_API_KEY_ID="KY-fi2ntYrYox2vNrrc1djhcd9AcG9xBNqMnZz7UeqTh"
COS_INSTANCE_CRN="crn:v1:bluemix:public:cloud-object-storage:global:a/07c65aa9711a45acb4e6def43cfd0eea:c8c25038-3a1a-4d73-904d-72500deae890::"
...
@app.route('/')
def index():
    files = get_bucket_contents('abhijeetbucket')
